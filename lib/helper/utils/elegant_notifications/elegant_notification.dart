...
import 'package:interview_task/helper/utils/elegant_notifications/resources/colors.dart';
...
import 'package:interview_task/helper/utils/elegant_notifications/widgets/animated_progress_bar.dart';
import 'package:interview_task/helper/utils/elegant_notifications/widgets/overlay_manager.dart';
import 'package:interview_task/helper/utils/elegant_notifications/widgets/toast_content.dart';
...
class ElegantNotification extends StatefulWidget {
  ...
  String get internalKey =>
      stackedOptions != null ? '${stackedOptions?.key}%${uniqueKey.toString()}' : uniqueKey.toString();
